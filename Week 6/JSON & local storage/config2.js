...
console.log("Here's the configObject");
console.log(configObject);

window.localStorage.setItem("myRectangleConfig", JSON.stringify(configObject));
console.log("\nHere's the stringified object returned from localStorage");
console.log(window.localStorage.getItem("myRectangleConfig"));

var s = JSON.parse(window.localStorage.getItem("myRectangleConfig"));
